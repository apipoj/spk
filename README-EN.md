...
| `session-reflect` | Stop | At session end, proposes (never writes) capturing a `learning` wiki page and re-priming any `AGENTS.md` whose subtree changed; disable with `SPK_SESSION_REFLECT=off` |

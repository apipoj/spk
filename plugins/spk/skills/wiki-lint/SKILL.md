...
Dispatch: `Task(subagent_type="spk-audit-orchestrator", prompt="Wiki lint — run spk-code-auditor with wiki-lint lens over ai_context/wiki/. Report issues + proposed auto-fixes.")`

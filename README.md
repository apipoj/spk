...
| `session-reflect` | Stop | จบ session แล้วเสนอ (ไม่เขียนไฟล์) ให้บันทึก `learning` wiki page และ prime `AGENTS.md` ของ subtree ที่เปลี่ยนใหม่ ปิดด้วย `SPK_SESSION_REFLECT=off` |
